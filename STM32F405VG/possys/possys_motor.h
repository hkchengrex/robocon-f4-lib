...
static const s16 MOTOR_ANGLE[WHEEL_NUM] = {0, 1200, 2400};
//static const s16 MOTOR_ANGLE[WHEEL_NUM] = {1800, 3000, 600};
//static const s16 MOTOR_ANGLE[WHEEL_NUM] = {150, 1650, 1950, 3450};
